...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Draw activity using Maui.Graphics
        if (args.Contains("-a"))
        {
    ...
    {
        // Draw activity data on the surface vertically using Maui.Graphics
    ...
    {
        // Draw activity data on the surface horizontally using Maui.Graphics
